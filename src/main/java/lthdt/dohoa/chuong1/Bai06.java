...
public class Bai06 extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtTruonghoc, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnNhap, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void btnNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapActionPerformed
     ...
     s.setTruonghoc(txtTruonghoc.getText());
     s.setGioitinh(cbGioitinh.getSelectedIndex());
     s.setNgaysinh(txtNgaysinh.getDate());
     SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy ", Locale.ENGLISH);
     String output = s.getHoten()+"; "+ df.format(s.getNgaysinh())+
             "; gioi tinh" + cbGioitinh.getSelectedItem().toString()+
             "; truong hoc"+s.getTruonghoc()+"\n";
